		...
		<div class="col-md-12">
			<div class="row">
					...
					<?php 
						...
						$detail2 = $this->db->query("SELECT COUNT(nomMatch) AS nombre, nomMatch,(SELECT SUM(montant)) as total,jour FROM profile_reservation WHERE etat_reservation=1 GROUP BY jour");
