    ...
    <!-- fin modal-->
     ...
     $(document).ready(function(){  
          ...
          var dataTable = $('#user_data').DataTable({  
               ...
               "order":[],  
               "ajax":{  
                    url:"<?php echo base_url() . 'admin/fetch_place'; ?>",  
                    type:"POST"  
               },  
               "columnDefs":[  
                    {  
               ...
               if(nomPlace != '' && idstade !='')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_place'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_place'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_place",  
                    method:"POST",  
              ...
              if(confirm("Are you sure you want to delete this?"))
		          {
		           		...
		           		$.ajax({
	                    url:"<?php echo base_url(); ?>admin/supression_place",
	                    method:"POST",
	                    data:{idplace:idplace},
	                    success:function(data)
	                    {
