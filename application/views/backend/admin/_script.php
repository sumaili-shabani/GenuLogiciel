...
<!-- Select picker -->
<script src="<?php echo(base_url())?>js/bootstrap-select-1.13.14/dist/js/bootstrap-select.min.js"></script>

<script src="<?php echo(base_url())?>js/bootstrap-select-1.13.14/dist/js/i18n/defaults-*.min.js"></script>
<!-- fin Select picker -->
