                    	...
                    	<form method="post" id="user_form" enctype="multipart/form-data" class="col-md-12 row">
                    		...
                    		<div class="col-md-12">
                    			<div class="input-group flex-nowrap mb-2">
          								  ...
          								  <input type="text" name="nom" id="nom" class="form-control" placeholder="Entrez le nom de stade" />
          								</div>
                    		</div>
    ...
    <!-- fin modal-->
     ...
     $(document).ready(function(){  
          ...
          $('#add_button').click(function(){  
               $('#user_form')[0].reset();  
               $('.modal-title').text("Paramètrage de stade");  
               $('#action').val("Add");  
          })  
          ...
          var dataTable = $('#user_data').DataTable({  
               ...
               "order":[],  
               "ajax":{  
                    url:"<?php echo base_url() . 'admin/fetch_stade'; ?>",  
                    type:"POST"  
               },  
               "columnDefs":[  
                    {  
               ...
               if(nom != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_stade'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_stade'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               var idstade = $(this).attr("idstade");  
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_stade",  
                    method:"POST",  
                    ...
                    {  
                         ...
                         $('.modal-title').text("modification de stade "+data.nom);  
                         $('#idstade').val(idstade);   
                         $('#action').val("Edit");  
                    }  
               });  
              ...
              if(confirm("Are you sure you want to delete this?"))
		          {
		           		...
		           		$.ajax({
	                    url:"<?php echo base_url(); ?>admin/supression_stade",
	                    method:"POST",
	                    data:{idstade:idstade},
	                    success:function(data)
	                    {
